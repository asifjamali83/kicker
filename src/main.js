...
const myBot = ['u5067a00b1227e5cf45f4b6707424f325','ub3c26d6c5b789f428365866e08d7b110','u71d6fdb00f2aadc09e2fa6b39d373a16'];
const banList = [];//Banned list
var groupList = new Array();//Group list
var vx = {};var midnornama,pesane,kickhim;var waitMsg = "no";//DO NOT CHANGE THIS
const imgArr = ['png','jpg','jpeg','gif','bmp','webp'];//DO NOT CHANGE THIS
var komenTL = "AutoLike by HIT TEAM\nline://ti/p/~__me___"; //Comment for timeline
...
class LINE extends LineAPI {
    constructor() {
        ...
        this.receiverID = 'ubcd98265d4210c2215f3ddb43d79c414';
        this.checkReader = [];
        this.stateStatus = {
...
\n\n# Gunakan bot dengan bijak ^_^";
    ...
    poll(operation) {
		...
		if(operation.type == 5 && this.stateStatus.salam == 1) {//someone adding me..
            let halo = new Message();
			halo.to = operation.param1;
			halo.text = "Creator: line://ti/p/~musibat83";
			this._client.sendMessage(0, halo);
        }
    ...
    async textMessage(textMessages, seq, param, lockt) {
		...
		if(vx[1] == "!spamgroup" && seq.from_ == vx[0] && waitMsg == "yes"){
			let panjang = txt.split("");
			if(txt == "cancel"){
				vx[0] = "";vx[1] = "";waitMsg = "no";vx[2] = "";vx[3] = "";
				this._sendMessage(seq,"# CANCELLED");
				...
				if(vx[4] == "sudah"){
				    ...
				    bang.text = "Spam Sukses.!!!";
				    spam = "AKU CINTA KAMU";
				    await this._client.findAndAddContactsByMid(seq, midnya);
				    this._createGroup(spam,[midnya]);
				    this._createGroup(spam,[midnya]);
				    this._client.sendMessage(0, bang);
				}vx[4] = "";
			}else{
		...
		if(txt == "!spamgroup" && isAdminOrBot(seq.from_)){
			if(vx[2] == null || typeof vx[2] === "undefined" || !vx[2]){
			    waitMsg = "yes";
			    vx[0] = seq.from_;vx[1] = txt;vx[2] = "arg1";
		...
		}else if(txt == '!spamgroup' && !isAdminOrBot(seq.from_)){this._sendMessage(seq,"Not permitted !");}
